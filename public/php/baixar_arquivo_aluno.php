...
class DownloadController {
    ...
    public function downloadArquivo() {
        ...
        if(isset($_GET['id'])) {
            ...
            $sql_query = "SELECT arquivo FROM arquivos WHERE id_aluno_arq = ?";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<script language='javascript' type='text/javascript'>alert('ID de arquivo invalido!');window.location.href='/listar_aluno';</script>";
            }
        } else {
            echo "ID de arquivo não fornecido.";
        }
    }
