...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" >
        <a class="navbar-brand" href="/listar_secretario"><img src="img/senai-logo.png" alt="" style="height: 3rem; width: auto; margin-right: 40px; margin-left: 0px;">Sistema de Frequência</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto" style="gap: 20px;">
            <li class="nav-item">
              <a class="nav-link" href="/ver_empresa">Ver Empresa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/listar_secretario">Ver relatorios</a>
            </li>
          </ul>
        </div>
